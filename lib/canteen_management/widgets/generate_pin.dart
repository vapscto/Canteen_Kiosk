...
class GeneratePinWidget extends StatefulWidget {
  final LoginSuccessModel loginSuccessModel;
  final MskoolController mskoolController;
  final CanteenManagementController controller;
  final String amount;

  const GeneratePinWidget(
      {super.key,
  ...
  @override
  State<GeneratePinWidget> createState() => _GeneratePinWidgetState();
}

class _GeneratePinWidgetState extends State<GeneratePinWidget> {
                ...
                return (widget.controller.isPinGenerate.value)
                    ...
                    : MSkollBtn(
                        ...
                        onPress: () async {
                          ...
                          //   await PinGenerateAPI.instance.pinGenerateAPI(
